      ...
      <section class="col-md-8">
        <div class="card-body">
          ...
          <p class="card-text lead">
            <b>Tech Stack:</b> Java, Object-Oriented Programming, Command-Line Interface
          </p>
          <p class="card-text lead">
          ...
          <p class="card-text text-muted lead">
            <em>A simple backend system, emphasizing core programming and software design practices.</em>
          </p>
        </div>
      </section>
